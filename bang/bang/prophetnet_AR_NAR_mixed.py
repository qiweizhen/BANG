...
@register_model('prophet_ar_nar_mixed')
class NgramTransformerProphetARNarMixedModel(FairseqEncoderDecoderModel):
    """
    Args:
    ...
    def build_model(cls, args, task):
        ...
        model = NgramTransformerProphetARNarMixedModel(encoder, decoder)
        ...
        return NgramTransformerProphetARNarMixedModel(encoder, decoder)
...
@register_model_architecture('prophet_ar_nar_mixed', 'prophet_ar_nar_mixed')
...
@register_model_architecture('prophet_ar_nar_mixed', 'prophet_ar_nar_mixed_base')
...
@register_model_architecture('prophet_ar_nar_mixed', 'prophet_ar_nar_mixed_middle')
...
@register_model_architecture('prophet_ar_nar_mixed', 'prophet_ar_nar_mixed_large')
